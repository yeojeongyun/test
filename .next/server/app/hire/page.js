...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8378);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 3931, 23)), "C:\\Users\\Mobiliverse\\Desktop\\gitpages\\test\\mobiliverse-page\\src\\app\\hire\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4838)), "C:\\Users\\Mobiliverse\\Desktop\\gitpages\\test\\mobiliverse-page\\src\\app\\layout.tsx"],
          metadata: {
    icon: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1053))],
    apple: [],
    opengraph: [],
    twitter: [],
  }
    ...
    const pages = ["C:\\Users\\Mobiliverse\\Desktop\\gitpages\\test\\mobiliverse-page\\src\\app\\hire\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3065))
...
module.exports = createProxy("C:\\Users\\Mobiliverse\\Desktop\\gitpages\\test\\mobiliverse-page\\src\\app\\hire\\page.tsx");
...
function Example() {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Hire, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(Name, {
                children: "인재 채용"
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(Contents, {
                children: "현재 채용중인 공고가 없습니다."
            })
        ]
    });
}
const fadeIn = styled_components__WEBPACK_IMPORTED_MODULE_2__/* .keyframes */ .F4`
  from {
    opacity: 0;
  }
  to {
...
`;
const Hire = styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"].div */ .ZP.div`
  ...
  min-width: 50%;
`;
const Name = styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"].p */ .ZP.p`
  font-weight: bold;
  font-size: 4rem;
`;
const Contents = styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"].p */ .ZP.p`
  font-size: 1.3rem;
...
var __webpack_exports__ = __webpack_require__.X(0, [359,518,342], () => (__webpack_exec__(4902)));
